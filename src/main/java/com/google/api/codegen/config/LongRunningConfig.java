...
public abstract class LongRunningConfig {
   ...
   * settings.
   */
  private static LongRunningConfig.@org.checkerframework.checker.objectconstruction.qual.CalledMethods({"setInitialPollDelay", "setPollDelayMultiplier", "setMaxPollDelay", "setTotalPollTimeout"}) Builder getGapicConfigLroRetrySettingsOrDefault(
