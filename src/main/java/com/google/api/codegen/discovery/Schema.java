...
public abstract class Schema implements Node {
  ...
  public static @org.checkerframework.checker.objectconstruction.qual.CalledMethods({"setDescription", "setDefaultValue", "setLocation", "setPattern", "setProperties", "setReference"}) Builder newBuilder() {
