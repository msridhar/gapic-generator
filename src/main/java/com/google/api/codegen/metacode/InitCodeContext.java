...
public abstract class InitCodeContext {
  ...
  public static @org.checkerframework.checker.objectconstruction.qual.CalledMethods({"symbolTable", "initValueConfigMap", "fieldConfigMap", "outputType", "additionalInitCodeNodes", "initFieldConfigStrings", "initFieldConfigStrings", "sampleParamConfigMap"}) Builder newBuilder() {
