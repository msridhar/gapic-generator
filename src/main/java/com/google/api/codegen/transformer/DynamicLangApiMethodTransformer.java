...
public class DynamicLangApiMethodTransformer {
  ...
  @org.checkerframework.checker.objectconstruction.qual.EnsuresCalledMethods(value = "#5", methods = {"apiClassName", "apiModuleName", "apiVariableName", "doc", "grpcMethodName", "grpcStreamingType", "hasRequestParameters", "hasReturnValue", "headerRequestParams", "isSingularRequestMethod", "key", "localPackageName", "methodParams", "name", "oneofParams", "optionalRequestObjectParams", "optionalRequestObjectParamsNoPageToken", "packageName", "requestTypeName", "requestVariableName", "requiredRequestObjectParams", "responseTypeName", "stubName", "topLevelAliasedApiClassName", "versionAliasedApiClassName"})
