...
public abstract class ClientTestClassView {
  ...
  public static @org.checkerframework.checker.objectconstruction.qual.CalledMethods({"apiHasUnaryUnaryMethod", "apiHasUnaryStreamingMethod", "apiHasStreamingUnaryMethod", "apiHasStreamingStreamingMethod", "hasLongRunningOperations"}) Builder newBuilder() {
